...
<title>dump remove_accents table</title>
...
#call remove accents to bring in chars array
remove_accents("\xC3\x84\xC3\x96\xC3\x9C");
...
echo otd;
$check1 = utf8toAscii($key); #iconv('UTF-8', 'ASCII//TRANSLIT', $key);
if ($check1 != $value) echo ' 1 '. $check1;
echo ctd;
