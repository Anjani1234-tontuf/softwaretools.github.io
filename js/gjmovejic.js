...
function CSGS(idin)
{
	...
	this.scrASGS[scrSGS.screenWidth]		  =	window.screen.width;
	this.scrASGS[scrSGS.screenHeight]		  =	window.screen.height;
	this.scrASGS[scrSGS.screenColorDepth]	  =	window.screen.colorDepth;
...
/*
"C:\ma\Personal\XXSoftwareTools\TstMoves.html"
file:///C:/ma/Personal/XXSoftwareTools/DumpCookiesXX.html

    debugCD = getCookieItem("gj53runOptions", "DebugHTML");  debug on

//screwed for IE 7 8 9   theXoffset,Yoffset, clientwidth,  clientheight, looking good
IE 9
getCW 1440 getCH 752 screen.width 1440 screen.height 900
window.innerWidth 1440 document.documentElement.clientWidth 1423 document.body.clientWidth 1407
 getXoffset() 0
 getYoffset() 0

Firefox 17 on Windows
getCW 1440 getCH 770 screen.width 1440 screen.height 900
window.innerWidth 1440 document.documentElement.clientWidth 1423 document.body.clientWidth 1407
getXoffset() 0
getYoffset() 0
...
CSGS.prototype.moveVertical	= function(newObjNum)
{
  ...
  if(isNaN(this.objASGS[newObjNum][objSGS.theIdCurrTop]) || isNaN(this.objASGS[newObjNum][objSGS.moveToTop]))
  {
...
CSGS.prototype.moveHorizontal =	function(newObjNum)
{
 ...
 if(isNaN(this.objASGS[newObjNum][objSGS.theIdCurrLeft]) || isNaN(this.objASGS[newObjNum][objSGS.moveToLeft]) || (!(this.objASGS[newObjNum][objSGS.theId])))
  {
...
CSGS.prototype.amIDone = function()
{
	...
	for	(var i = 1;	i <= this.objASGS[NO.NUMBEROBJECTS]; i++)
	{
		...
		{
			var mymsg	 = 'Object done	Number ' + i ;
			this.dump(i, mymsg);
